...
ジャガーの直列6気筒（XKエンジンから、AJ6、そして1994年のX300型XJが積むAJ16まで）は、**シリンダーブロックが鋳鉄**でできています。
...
その頑丈な下半身に対して、頭（シリンダーヘッド）は**半球型に近い燃焼室と素直な吸排気の流れ**を持ち、高回転まできれいに回るように作られています。**下は頑丈に、上は高性能に**。この組み合わせが、レースで勝ちながら乗用車として何十年も使われ続けた土台になっています。

## V8・V12 ── 軽さと滑らかさ

一方、V12（1971年〜1997年）と、1996年のXK8から始まるV8「AJ-V8」は**アルミ合金のブロック**です。重い12気筒・8気筒を鋳鉄で作ると前が重くなりすぎるため、素材で軽さを稼いでいます。

こちらは頑丈さより**滑らかさと静けさ**が身上です。とくにV12は、代わりになるものが無いと言われる回り方をします。ただしアルミは熱に弱く、**冷却系の管理が寿命を決めます**。この点は直6より神経を使う、と正直に申し上げています。

**「丈夫な直6か、滑らかなV8・V12か」**——どちらを選ぶかで、付き合い方が変わります。
